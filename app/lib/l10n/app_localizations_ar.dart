...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get revOrientPe =>
      'كم جنيهًا تدفعه مقابل كل جنيه من أرباح السنة. الأقل يعني أنك تدفع أقل مقابل نفس الربح — أي أرخص. لكن الرقم المنخفض جدًا قد يكون تحذيرًا بأن السوق يتوقع تراجع الأرباح.';

  @override
  String get revOrientPb =>
      'السعر مقابل كل جنيه من صافي قيمة الشركة الدفترية. الأقل يعني أنك تدفع أقل مقابل تلك القيمة — أرخص — وإن كان الرقم المنخفض قد يشير أيضًا إلى أصول يشكّك فيها السوق.';

  @override
  String get revOrientYield =>
      'التوزيع النقدي الذي تحصل عليه سنويًا مقابل كل جنيه مستثمر. الأعلى يدفع لك أكثر — لكن العائد المرتفع جدًا غالبًا يعني أن السعر قد هبط، أو أن التوزيع قد يُخفَّض.';

  @override
  String get revOrientHigherMore =>
      'الأعلى ببساطة أكثر — ربح أكبر، أو أرباح أكبر لكل سهم. والارتفاع بمرور الوقت هو الاتجاه الصحي.';

  @override
  String get revOrientCash =>
      'كم من الربح المُعلن وصل فعلًا كنقد. الأعلى أصح — نقد في البنك، وليس ربحًا على الورق فقط.';

  @override
  String get revOrientReturn =>
      'كم ربحًا تحققه الشركة من الأموال الموضوعة فيها. الأعلى يعني كفاءة أكبر — ربح أكبر لكل جنيه. والأعلى باستمرار هو الجانب الأقوى.';

  @override
  String get revOrientDebt =>
      'كم اقترضت الشركة مقابل أموالها الخاصة. الأقل يعني ديونًا أقل ومخاطر أقل عند الضيق — وإن كان بعض الاقتراض طبيعيًا وقد يموّل النمو.';

  @override
  String get revOrientAssets =>
      'الأعلى يعني شركة أكبر بما تملكه. الأكبر ليس أفضل تلقائيًا — فالأصول لا تزال عليها أن تحقق عائدًا.';
}
