...
/// not a benchmark.
 String? get peer;@JsonKey(name: 'peer_median') double? get peerMedian;/// A probable answer to the question this metric leaves open, generated by
/// `build_review_reads.py` from the sibling directions and vetted like the
/// read. Distinct from [cause], the deterministic pointer the builder
/// computes: this is the model's short reading of the *likely reason* the
/// metric is moving as it is. Empty when the metric was flat, or when no
/// probable reason was offered.
 String get answer;@JsonKey(name: 'answer_ar') String get answerAr;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReviewMetric&&(identical(other.key, key) || other.key == key)&&(identical(other.value, value) || other.value == value)&&(identical(other.unit, unit) || other.unit == unit)&&(identical(other.direction, direction) || other.direction == direction)&&(identical(other.points, points) || other.points == points)&&const DeepCollectionEquality().equals(other.series, series)&&(identical(other.cause, cause) || other.cause == cause)&&(identical(other.peer, peer) || other.peer == peer)&&(identical(other.peerMedian, peerMedian) || other.peerMedian == peerMedian)&&(identical(other.answer, answer) || other.answer == answer)&&(identical(other.answerAr, answerAr) || other.answerAr == answerAr));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,key,value,unit,direction,points,const DeepCollectionEquality().hash(series),cause,peer,peerMedian,answer,answerAr);

@override
String toString() {
  return 'ReviewMetric(key: $key, value: $value, unit: $unit, direction: $direction, points: $points, series: $series, cause: $cause, peer: $peer, peerMedian: $peerMedian, answer: $answer, answerAr: $answerAr)';
}
...
@useResult
$Res call({
 String key, double value, String unit, String direction, int points,@JsonKey(fromJson: reviewPointsFromJson) List<ReviewPoint> series, String? cause, String? peer,@JsonKey(name: 'peer_median') double? peerMedian, String answer,@JsonKey(name: 'answer_ar') String answerAr
});
...
/// Create a copy of ReviewMetric
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? key = null,Object? value = null,Object? unit = null,Object? direction = null,Object? points = null,Object? series = null,Object? cause = freezed,Object? peer = freezed,Object? peerMedian = freezed,Object? answer = null,Object? answerAr = null,}) {
  return _then(_self.copyWith(
...
as double?,answer: null == answer ? _self.answer : answer // ignore: cast_nullable_to_non_nullable
as String,answerAr: null == answerAr ? _self.answerAr : answerAr // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String key,  double value,  String unit,  String direction,  int points, @JsonKey(fromJson: reviewPointsFromJson)  List<ReviewPoint> series,  String? cause,  String? peer, @JsonKey(name: 'peer_median')  double? peerMedian,  String answer, @JsonKey(name: 'answer_ar')  String answerAr)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewMetric() when $default != null:
return $default(_that.key,_that.value,_that.unit,_that.direction,_that.points,_that.series,_that.cause,_that.peer,_that.peerMedian,_that.answer,_that.answerAr);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String key,  double value,  String unit,  String direction,  int points, @JsonKey(fromJson: reviewPointsFromJson)  List<ReviewPoint> series,  String? cause,  String? peer, @JsonKey(name: 'peer_median')  double? peerMedian,  String answer, @JsonKey(name: 'answer_ar')  String answerAr)  $default,) {final _that = this;
switch (_that) {
case _ReviewMetric():
return $default(_that.key,_that.value,_that.unit,_that.direction,_that.points,_that.series,_that.cause,_that.peer,_that.peerMedian,_that.answer,_that.answerAr);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String key,  double value,  String unit,  String direction,  int points, @JsonKey(fromJson: reviewPointsFromJson)  List<ReviewPoint> series,  String? cause,  String? peer, @JsonKey(name: 'peer_median')  double? peerMedian,  String answer, @JsonKey(name: 'answer_ar')  String answerAr)?  $default,) {final _that = this;
switch (_that) {
case _ReviewMetric() when $default != null:
return $default(_that.key,_that.value,_that.unit,_that.direction,_that.points,_that.series,_that.cause,_that.peer,_that.peerMedian,_that.answer,_that.answerAr);case _:
  return null;
...
class _ReviewMetric extends ReviewMetric {
  const _ReviewMetric({this.key = '', this.value = 0, this.unit = 'ratio', this.direction = 'unknown', this.points = 0, @JsonKey(fromJson: reviewPointsFromJson) final  List<ReviewPoint> series = const <ReviewPoint>[], this.cause, this.peer, @JsonKey(name: 'peer_median') this.peerMedian, this.answer = '', @JsonKey(name: 'answer_ar') this.answerAr = ''}): _series = series,super._();
...
/// A probable answer to the question this metric leaves open, generated by
/// `build_review_reads.py` from the sibling directions and vetted like the
/// read. Distinct from [cause], the deterministic pointer the builder
/// computes: this is the model's short reading of the *likely reason* the
/// metric is moving as it is. Empty when the metric was flat, or when no
...
@override@JsonKey(name: 'answer_ar') final  String answerAr;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,key,value,unit,direction,points,const DeepCollectionEquality().hash(_series),cause,peer,peerMedian,answer,answerAr);
...
/// Create a copy of ReviewMetric
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? key = null,Object? value = null,Object? unit = null,Object? direction = null,Object? points = null,Object? series = null,Object? cause = freezed,Object? peer = freezed,Object? peerMedian = freezed,Object? answer = null,Object? answerAr = null,}) {
