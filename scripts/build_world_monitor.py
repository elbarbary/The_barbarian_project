        ...
        "channels": [
            {
                ...
                "plain": "When interest rates change, companies that borrow feel it first. Here is every company that filed a borrowings figure, and how much of it reprices within a year.",
                "plainAr": "حين يتغير سعر الفائدة تشعر به الشركات المقترضة أولاً. هنا كل شركة أودعت رقم قروضها، وكم منها يُعاد تسعيره خلال عام.",
            ...
            },
            {
                ...
                "plain": "When oil or the dollar moves, companies that get their inputs from abroad feel it. Here is every company that filed revenue and gross profit; the gap between them is what absorbs a shock.",
                "plainAr": "حين يتحرك النفط أو الدولار تشعر به الشركات التي تشتري موادها من الخارج. هنا كل شركة أودعت إيراداتها ومجمل ربحها؛ والفارق بينهما هو ما يمتصّ الصدمة.",
            ...
            *([{
                ...
                "plain": "When the pound moves, companies holding money in other currencies gain or lose on paper. Here is every company whose filings print such a figure.",
                "plainAr": "حين يتحرك الجنيه تربح الشركات التي تحتفظ بأموال بعملات أخرى أو تخسر على الورق. هنا كل شركة تطبع قوائمها رقماً من هذا النوع.",
