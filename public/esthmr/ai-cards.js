...
export function aiCards(component, data, ar) {
  ...
  return h('div', { class: 'ai-cards', role: 'region', 'aria-labelledby': 'aix-lab-title' },
    h('section', { class: 'aix-lab' },
      ...
      h('h2', { id: 'aix-lab-title', class: 'aix-lab-title' }, t('The model lab', 'مختبر النماذج')),
      h('p', { class: 'aix-lab-lead' }, t(
        `${models ? `${Word(models)} public models` : 'Public models'} rank every listed company after each close. We read a saved record and run no new calculation. We hold nothing and we advise nothing.`,
        `${models ? countAr(models, 'نموذج عام واحد', 'نموذجان عامان', 'نماذج عامة', 'نموذجًا عامًا') : 'نماذج عامة'} ترتّب كل شركة مدرجة بعد كل إغلاق. نقرأ سجلًا محفوظًا ولا نُجري حسابًا جديدًا، ولا نملك ولا نوصي.`)),
