...
const WORDS = {
  ...
  ar: {
    ...
    lead: 'بلومبرج البورصة المصرية... مجاناً لكل مستثمر. إفصاحات الشركات الحقيقية، رادار صفقات الداخليين، ومؤشر أعباء الديون والسيولة. سجّل الدخول ببريدك ونرسل لك رمزاً من ستة أرقام — بلا كلمة سر ولا اشتراكات.',
