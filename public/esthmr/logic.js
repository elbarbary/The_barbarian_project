...
export class Component extends Base {
  ...
  copy() {
    ...
    const ar = {
      ...
      revRoeBody:'كم جنيهاً تربحه الشركة في السنة على كل مئة جنيه تركها أصحابها فيها. والعائد المرتفع ليس مبهراً بالضرورة — فالاقتراض يُصغّر حقوق الملكية فترتفع النسبة دون أن يتحسّن النشاط. اقرأه دائماً بجوار نسبة الدين إلى حقوق الملكية.',
      ...
      screenBarsShort:'طول العمود = كم شركة. موضعه = أين تقع على المقياس. الخط = نقطة المقارنة.',
