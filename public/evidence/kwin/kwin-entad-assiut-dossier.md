...
```mermaid
flowchart TD
    ADIB["ADIB Egypt<br/>direct owner/controller"]
    KWIN["KWIN<br/>listed; 10.5m shares"]
    ENTAD["ENTAD<br/>private investment/trading company"]
    AARE["Abu Dhabi Islamic Real Estate Investment<br/>ENTAD-controlled property subsidiary"]
    AAGRI["Assiut Agricultural Development<br/>private operating/investment company"]
    AITG["Assiut Islamic / AITG<br/>delisted July 2021; buyer-consortium control"]

    ADIB -->|"64.75% / 6,798,611 KWIN shares"| KWIN
    ADIB -->|"40% direct ENTAD stake"| ENTAD
    KWIN -->|"51.22% ENTAD after buying AITG's<br/>738,423-share / 15.74% ENTAD block"| ENTAD
    ENTAD -->|"25.2475% / 2,650,989 KWIN shares after buying<br/>AITG's 928,287-share / 8.84% KWIN block"| KWIN
    ENTAD -->|"~99.77%"| AARE
    KWIN -->|"89.46% after 1 May 2023"| AAGRI
    AITG -.->|"16 Mar 2023: sold 928,287 KWIN shares<br/>8.84% of KWIN · EGP 11.873m"| ENTAD
    AITG -.->|"30 Apr 2023: sold 738,423 ENTAD shares<br/>15.74% of ENTAD · EGP 15.677m"| KWIN
    AITG -.->|"1 May 2023: sold 790,530 AAGRI shares<br/>19.76% of AAGRI · EGP 8.577m"| KWIN
```
...
```mermaid
flowchart LR
    KWIN["KWIN<br/>Amr receivable falls EGP 31.328m in 2023"]
    AMR["Amr Abu El‑Eyoun<br/>buyer / debtor"]
    AITG["Assiut Islamic<br/>seller of residual group stakes"]
    ENTAD["ENTAD<br/>buyer of KWIN block"]

    KWIN -->|"EGP 24.254m purchase obligations"| AITG
    ENTAD -->|"EGP 11.873m purchase obligation"| AITG
    AMR -->|"Possible payment / set-off / assignment<br/>not established"| KWIN
    AITG -.->|"Possible cash, dividend, loan or set-off path<br/>not established"| AMR
```
...
```mermaid
flowchart LR
    AITG["AITG<br/>seller of three legacy investments"]
    ENTAD["ENTAD<br/>buyer"]
    KWIN["KWIN<br/>buyer"]
    CASH["Cash received by AITG<br/>EGP 36.127m total"]

    AITG -->|"928,287 KWIN shares<br/>8.84% of KWIN<br/>EGP 11.873m"| ENTAD
    AITG -->|"738,423 ENTAD shares<br/>15.74% of ENTAD<br/>EGP 15.677m"| KWIN
    AITG -->|"790,530 Assiut Agricultural shares<br/>19.76% of company<br/>EGP 8.577m"| KWIN

    ENTAD -->|"resulting cross-holding:<br/>25.25% of KWIN"| KWIN
    KWIN -->|"resulting control:<br/>51.22% of ENTAD"| ENTAD

    ENTAD -.->|"EGP 11.873m"| CASH
    KWIN -.->|"EGP 24.254m"| CASH
```
